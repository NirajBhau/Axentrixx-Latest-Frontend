              ...
              {!isSuccess ? (
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-0">
                    <button
                      ...
                      className="inline-flex items-center justify-center rounded-md bg-primary px-10 py-3 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-primary/90 disabled:bg-primary/70 disabled:cursor-not-allowed"
                    >
                ...
                <div className="text-center py-10">
                  ...
                  <button
                    ...
                    className="mt-6 inline-flex items-center justify-center rounded-md bg-primary px-10 py-3 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-primary/90"
                  >
