...
const SingleTeam = ({ team }: { team: TeamType }) => {
  ...
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
      <div className="group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none min-h-[400px] transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
        <div className="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
          <div className="w-full h-full rounded-full bg-gray-200 dark:bg-dark-3 flex items-center justify-center border-4 border-white dark:border-dark-3 relative z-20">
            <svg
        ...
        <div className="text-center">
          ...
          {team.bio && (
            <p className="mb-5 text-sm text-body-color/70 dark:text-dark-6/70">
              {team.bio}
            </p>
          )}
          <div className="flex items-center justify-center gap-5">
            {linkedinLink && (
              <Link
                ...
                href={linkedinLink}
                className="text-dark-6 hover:text-[#0077B5] transition-all duration-300 hover:scale-110"
              >
                <svg
                  width="18"
                  height="18"
