...
export const metadata: Metadata = {
  ...
  title: {
    default: "Axentrixx - High-Performance Web Development Partner & AI Solutions",
    template: "%s | Axentrixx",
  },
  description:
    "Axentrixx is a premier web development partner for agencies and global businesses. We engineer fast, modern Next.js websites, AI tools, mobile apps, and enterprise software.",
  keywords: [
    "Axentrixx",
  ...
  openGraph: {
    ...
    siteName: "Axentrixx",
    title: "Axentrixx - High-Performance Web Development & AI Solutions",
    description:
      "Axentrixx is a premier web development partner for agencies and global businesses. We engineer fast, modern Next.js websites, AI tools, and enterprise software.",
    images: [
      {
        url: "/images/logo/axenlogo.png",
        width: 1200,
        height: 630,
        alt: "Axentrixx - High-Performance Web Development Partner",
      },
    ],
  },
  twitter: {
